// From the web3.js file, deploy.js import the web3 instance of ganache-cli 
// and web3network as ganache.
const fs = require("fs");
...
// this ganache is the name of the docker container in which ganache-cli is running
